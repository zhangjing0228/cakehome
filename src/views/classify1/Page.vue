<template>
    <div id="page">
        ...
        <mt-tabbar fixed>
            ...
            <mt-tab-item class="reder"><span @click="addCart">加入购物车</span></mt-tab-item>
        </mt-tabbar>
        ...
        methods: {
            addCart() {
                ...
                let obj = {
                    ...
                    content: this.header.details,
                    price: this.header.price,
